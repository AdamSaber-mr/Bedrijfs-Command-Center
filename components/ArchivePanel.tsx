...
// Archief van alle chats en rapporten — leeft als tabblad in Instellingen,
// zoals bij Claude.ai.
export default function ArchivePanel() {
  ...
  return (
    <div>
      ...
      {compare && (
        <section className="animate-fade-up mt-5">
          <div className="flex items-baseline justify-between">
            <h3 className="font-[family-name:var(--font-display)] text-base font-semibold text-slate-900 dark:text-slate-100">
              Vergelijking
            </h3>
            <button
      ...
      <div className="mt-4 overflow-x-auto rounded-2xl border border-slate-900/10 bg-white dark:border-white/10 dark:bg-white/[0.03]">
        {tab === "chats" ? (
